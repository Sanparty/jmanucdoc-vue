...
const pledgesMain = {
    ...
    pledgeMain: {
        message: "I’m the agent who specializes in this local market – and has the reputation for putting you, the client, first. Any time you want information on the market or are ready to buy or sell a property – contact me. There’s no obligation.",
