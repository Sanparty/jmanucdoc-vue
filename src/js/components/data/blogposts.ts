...
const blogpost35: Blogpost = {
  ...
  date: "October 9, 2023",
  paragraph1:
    "When you show your home to prospective buyers, there is probably a long list of things you’re hoping they’ll notice. But what about those things you’re hoping buyers will not notice?",
...
const blogpost38: Blogpost = {
  ...
  paragraph1:
    "It’s amazing how much damage water can cause. Just two gallons of water from a burst pipe or overflowing toilet can wreak havoc throughout your home and necessitate thousands of dollars in repairs. Ouch! What should you do at the first sign of water leakage?",
...
const blogpost45: Blogpost = {
  ...
  paragraph1:
    "No matter how much you love your current home, you may still be dreaming of the day you can buy up into a better home in a better neighborhood. Is that day today or a few years down the road?",
...
const blogpost57: Blogpost = {
  ...
  date: "August 12, 2024",
  paragraph1:
    "What will your housing needs be in three to five years? If you can figure that out, you can watch the market, target areas and communities you might like to live in, and reap the benefits of planning ahead.",
...
const blogpost61: Blogpost = {
  id: "blog61",
  blogName: "5 Easy-to-Forget Things to Do",
  author: "John Manucdoc",
  date: "October 7, 2024",
  paragraph1:
  ...
  content: `<p>When you have a buyer coming to view your property, you want to make the best impression possible. So, you do the usual things. You clean, tidy and declutter. However, some details are easy to forget.</p>
<p>For example:</p>
<ol>
<li>Is there a mat by the front door for shoes, umbrellas, etc.?</li>
<li>Did you air out the home as much as possible to get rid of any lingering smells from a pet, recent cooking, etc.?</li>
<li>Did you empty trash bins?</li>
<li>Is the buyer (or his or her agent) aware of any doors that may have special locking mechanisms? If not, leave a note with instructions. For example, “To open the patio door, pull up the deadbolt lock at the bottom.”</li>
<li>Are there any kids’ toys on the floor that might accidently get damaged or be a tripping hazard?</li>
</ol>
<p>The better your home shows to buyers, the more likely you are to get an offer.</p>`,
  link: "blogpost61.html",
  image: "blog61.png",
